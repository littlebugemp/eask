...
public class Solution implements com.limbo.graphql.generated.types.SearchableItem {
  private String id;
  ...
  public static com.limbo.graphql.generated.types.Solution.Builder newBuilder() {
    return new Builder();
  }
  ...
  public static class Builder {
    ...
    public Solution build() {
                  com.limbo.graphql.generated.types.Solution result = new com.limbo.graphql.generated.types.Solution();
                      result.id = this.id;
    ...
    public com.limbo.graphql.generated.types.Solution.Builder id(String id) {
      this.id = id;
      return this;
    }

    public com.limbo.graphql.generated.types.Solution.Builder createDateTime(
        OffsetDateTime createDateTime) {
      this.createDateTime = createDateTime;
      return this;
    }

    public com.limbo.graphql.generated.types.Solution.Builder prettyCreateDateTime(
        String prettyCreateDateTime) {
      this.prettyCreateDateTime = prettyCreateDateTime;
      return this;
    }

    public com.limbo.graphql.generated.types.Solution.Builder content(String content) {
      this.content = content;
      return this;
    }

    public com.limbo.graphql.generated.types.Solution.Builder category(SolutionCategory category) {
      this.category = category;
      return this;
    }

    public com.limbo.graphql.generated.types.Solution.Builder voteAsGoodCount(
        Integer voteAsGoodCount) {
      this.voteAsGoodCount = voteAsGoodCount;
      return this;
    }

    public com.limbo.graphql.generated.types.Solution.Builder voteAsBasCount(
