...
public class Problem implements com.limbo.graphql.generated.types.SearchableItem {
  private String id;
  ...
  public static com.limbo.graphql.generated.types.Problem.Builder newBuilder() {
    return new Builder();
  }
  ...
  public static class Builder {
    ...
    public Problem build() {
                  com.limbo.graphql.generated.types.Problem result = new com.limbo.graphql.generated.types.Problem();
                      result.id = this.id;
    ...
    public com.limbo.graphql.generated.types.Problem.Builder id(String id) {
      this.id = id;
      return this;
    }

    public com.limbo.graphql.generated.types.Problem.Builder createDateTime(
        OffsetDateTime createDateTime) {
      this.createDateTime = createDateTime;
      return this;
    }

    public com.limbo.graphql.generated.types.Problem.Builder prettyCreateDateTime(
        String prettyCreateDateTime) {
      this.prettyCreateDateTime = prettyCreateDateTime;
      return this;
    }

    public com.limbo.graphql.generated.types.Problem.Builder title(String title) {
      this.title = title;
      return this;
    }

    public com.limbo.graphql.generated.types.Problem.Builder content(String content) {
      this.content = content;
      return this;
    }

    public com.limbo.graphql.generated.types.Problem.Builder tags(List<String> tags) {
      this.tags = tags;
      return this;
    }

    public com.limbo.graphql.generated.types.Problem.Builder solutionCount(int solutionCount) {
      this.solutionCount = solutionCount;
      return this;
    }
  }
